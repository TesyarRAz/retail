...
return [
    ...
    */
    ...
    'logo' => '<center><b>' . env('APP_NAME') . '</b></center>',
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'assets/js/responsive-datatables.js',
                ],
            ],
        ],
        'Select2' => [
        ...
        'MaskMoney' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/jquery-mask-plugin@1.14.16/dist/jquery.mask.min.js'
                ]
            ]
        ],
        'ImagePreview' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'assets/js/image-preview.js',
                ],
            ],
        ],
    ],
